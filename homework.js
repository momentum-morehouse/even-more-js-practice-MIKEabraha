...
//function minimum(array) {
 //   let minimum = array[0] // tells the program to return 1st number
  //  for (let number of array) { //for every number in the array test if it is less than current minimum
    //    if (number < minimum) { //when the new number is less than current min. replace it..e.g. sports records being replaced
 //           minimum = number
